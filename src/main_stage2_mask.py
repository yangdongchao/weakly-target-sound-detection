...
class Runner(object):
    ...
    def _forward(model, batch):
        ...
        w_decision_time,w_clip_decision,w_decision_up, mask_loss = model(inputs,embedding,clip_level_targets)
        return w_decision_time, w_clip_decision, w_decision_up, clip_level_targets, mask_loss
    ...
    def train(self, config, **kwargs):
        ...
        def _train_batch(_, batch):
            ...
            with torch.enable_grad():
                optimizer.zero_grad()
                w_decision_time, w_clip_decision, w_decision_up, clip_level_target, mask_loss = self._forward(model, batch)
        ...
        metrics = {
            'Loss': losses.Loss_stage2_mask(criterion),  #reimplementation of Loss, supports 3 way loss 
    ...
    def evaluate(
        ...
        config_parameters['label'] = '/apdcephfs/share_1316500/donchaoyang/code2/data/choose_class/strong_and_weakly_eval_psds.tsv'
        # postprocessing='median'
