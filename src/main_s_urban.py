...
class Runner(object):
    ...
    def evaluate(
        ...
        # config_parameters['test_data'] = '/apdcephfs/share_1316500/donchaoyang/code2/data/additional_urban_sed/h5/eval_urban_no_neg.h5'
        # config_parameters['label'] = '/apdcephfs/share_1316500/donchaoyang/code2/data/additional_urban_sed/filelist/strong_urban_eval_neg_psd_no.tsv'
        # postprocessing='median'
        ...
        dataloader = dataset.getdataloader_s_test_urban(
